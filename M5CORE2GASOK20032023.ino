...
void loop() {
  ...
  if (M5.BtnA.wasPressed() == true) {
    ...
    static const double HOME_LAT = 51.8610070, HOME_LON = 8.2893300;  //YOUR HOME POSITION
    M5.Lcd.setTextSize(2);
    M5.Lcd.setTextColor(CYAN, BLACK);
  ...
  if (M5.BtnB.wasPressed() == true) {
    ...
    static const double HOME_LAT = (gps.location.lat(), 6), HOME_LON = (gps.location.lng(), 6);
    M5.Lcd.setTextSize(2);
    M5.Lcd.setTextColor(CYAN, BLACK);
    M5.Lcd.setCursor(108, 137);
  ...
  if (M5.BtnC.wasPressed() == true) {
    M5.Lcd.fillRoundRect(100, 136, 214, 96, 4, BLACK);
    static const double HOME_LAT = 78.2355500, HOME_LON = 15.491380;
    M5.Lcd.setTextSize(2);
    M5.Lcd.setTextColor(CYAN, BLACK);
    M5.Lcd.setCursor(108, 137);
  ...
  static const double HOME_LAT = 51.861129, HOME_LON = 8.289280;  //YOUR HOME POSITION
  //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
  ...
  for (int i = 0; i < 60; i++) {
    ...
    M5.Lcd.drawLine(r, q, x, y, DARKCYAN);
  }  //*/
  ...
  //******************************************************************************************************************************************
  M5.Lcd.drawLine(r + 1, q + 1, x, y, WHITE);
  M5.Lcd.drawLine(r - 1, q - 1, x, y, WHITE);
  ...
  if (EMF > 4000) {
    M5.Lcd.fillRoundRect(289, 30, 19, 11, 3, RED);
  } else if (EMF > 3500) {
    M5.Lcd.fillRoundRect(289, 40, 19, 11, 3, RED);
  } else if (EMF > 3000) {
    M5.Lcd.fillRoundRect(289, 50, 19, 11, 3, RED);
  } else if (EMF > 2500) {
    M5.Lcd.fillRoundRect(289, 60, 19, 11, 3, ORANGE);
  } else if (EMF > 2000) {
  ...
  if ((gps.location.lat() == 0) && (gps.location.lng() == 0)) {
    M5.Lcd.print("---");
  } else if (TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) < 1000) {
    M5.Lcd.print(TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON), 0);
    M5.Lcd.print("m   ");
  } else {
    M5.Lcd.print(TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000, 2);
    M5.Lcd.print("km   ");
  }
  ...
  if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 > 43200) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.print("      S");
    //M5.Lcd.print("     "); //***********************************************************************************************************
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 == 1440) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print(((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) / 24, 1);
    M5.Lcd.print(" DAY");
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 >= 1441) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print(((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) / 24, 1);
    M5.Lcd.print(" DAYS");
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 == 60) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3, 2);
    M5.Lcd.print(" HOUR");
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 > 60) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3, 2);
    M5.Lcd.print(" HOURS");
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 > 1.5) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print(((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60, 0);
    M5.Lcd.print(" MINUTES");
  } else if (((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60 >= 0.5) {
    M5.Lcd.fillRect(12, 222, 80, 9, BLACK);
    M5.Lcd.setTextColor(YELLOW, BLACK);
    M5.Lcd.print(((TinyGPSPlus::distanceBetween(gps.location.lat(), gps.location.lng(), HOME_LAT, HOME_LON) / 1000) / 3) * 60, 0);
    M5.Lcd.print(" MINUTE");
